...
- lit,
- détecte les caractères génériques et les affiche,
...
- [Liste des fonctionnalités prises en charge](#liste-des-fonctionnalités-prises-en-charge)
- [Installation et compilation](#installation-et-compilation)
- [Utilisation](#utilisation)
- [Fonctionnalités](#fonctionnalités)
- [Flowchart, fonctionnement interne](#flowchart-fonctionnement-interne)
...
_printf affiche une sélection de caractères dont le contenu et le format sont choisis par l'utilisateur. Par exemple: 

      _printf("Hello %s, %d !", World, 2026); -> "Hello world, 2026 !"

La fonction doit être saisie comme suit :  
      
      _printf("texte et specificateur", var1, var2...);  
